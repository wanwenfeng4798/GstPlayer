...
/// Shared Bilibili-style chrome (center play, lock, two-row bottom bar).
/// 共享 B 站风格控件（中央播放、锁屏、两行底栏）。
class BiliChromeVideoControls extends StatefulWidget {
  /// Creates shared chrome with [icons] for Material or Cupertino.
  const BiliChromeVideoControls({
    super.key,
    required this.model,
    required this.theme,
  ...
  @override
  State<BiliChromeVideoControls> createState() =>
      _BiliChromeVideoControlsState();
}

class _BiliChromeVideoControlsState extends State<BiliChromeVideoControls> {
